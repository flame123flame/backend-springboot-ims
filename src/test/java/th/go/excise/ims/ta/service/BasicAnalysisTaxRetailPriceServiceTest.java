...
//	@Test
	public void test_inquiry() {
		...
		List<BasicAnalysisTaxRetailPriceVo> voList = basicAnalysisTaxRetailPriceService.inquiry(formVo);
...
//	@Test
	public void test_getJasperPrint() throws Exception {
		...
		JasperPrint jasperPrint = basicAnalysisTaxRetailPriceService.getJasperPrint(formVo, taxAuditDetailVo);

...
public class ServicePaperQtyServiceTest {
	...
	@Autowired
	private ServicePaperQtyService servicePaperQtyService;
	...
	public void test_inquiry() {
		...
		ServicePaperVo vo = servicePaperQtyService.inquiry(formVo);
	...
	public void test_export() {
		...
		try (FileOutputStream os = new FileOutputStream(OUTPUT_PATH + "/" + fileName)) {
			byte[] bytes = servicePaperQtyService.export(formVo);
			os.write(bytes);

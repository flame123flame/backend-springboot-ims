...
//	@Test
	public void test_inquiry() {
		...
		List<BasicAnalysisTaxQtyVo> voList = basicAnalysisTaxQtyService.inquiry(formVo);
...
//	@Test
	public void test_getJasperPrint() throws Exception {
		...
		JasperPrint jasperPrint = basicAnalysisTaxQtyService.getJasperPrint(formVo, taxAuditDetailVo);

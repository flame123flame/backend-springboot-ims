...
//	@Test
	public void test_inquiry() {
		...
		List<BasicAnalysisTaxRateVo> voList = basicAnalysisTaxRateService.inquiry(formVo);
...
//	@Test
	public void test_getJasperPrint() throws Exception {
		...
		JasperPrint jasperPrint = basicAnalysisTaxRateService.getJasperPrint(formVo, taxAuditDetailVo);

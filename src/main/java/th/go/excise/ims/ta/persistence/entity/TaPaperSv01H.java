...
@Entity
@Table(name = "TA_PAPER_SV01_H")
public class TaPaperSv01H extends BaseEntity {

	private static final long serialVersionUID = 4026667686338151259L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_SV01_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_SV01_H_GEN", sequenceName = "TA_PAPER_SV01_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_SV01_H_SEQ")
	private Long paperSv01HSeq;
	...
	public Long getPaperSv01HSeq() {
		return paperSv01HSeq;
	}

	public void setPaperSv01HSeq(Long paperSv01HSeq) {
		this.paperSv01HSeq = paperSv01HSeq;
	}

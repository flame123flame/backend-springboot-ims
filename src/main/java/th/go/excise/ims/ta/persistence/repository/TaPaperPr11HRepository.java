...
public interface TaPaperPr11HRepository extends CommonJpaCrudRepository<TaPaperPr11H, Long> {
	...
	public TaPaperPr11H findByPaperPrNumber(@Param("paperPrNumber") String paperPrNumber);

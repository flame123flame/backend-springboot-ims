...
public interface TaPaperPr04HRepository extends CommonJpaCrudRepository<TaPaperPr04H, Long> {
	...
	public TaPaperPr04H findByPaperPrNumber(@Param("paperPrNumber") String paperPrNumber);

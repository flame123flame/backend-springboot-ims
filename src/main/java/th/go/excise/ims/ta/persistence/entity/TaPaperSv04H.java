...
@Entity
@Table(name = "TA_PAPER_SV04_H")
public class TaPaperSv04H extends BaseEntity {

	private static final long serialVersionUID = 7174828531241328103L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_SV04_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_SV04_H_GEN", sequenceName = "TA_PAPER_SV04_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_SV04_H_SEQ")
	private Long paperSv04HSeq;
	...
	public Long getPaperSv04HSeq() {
		return paperSv04HSeq;
	}

	public void setPaperSv04HSeq(Long paperSv04HSeq) {
		this.paperSv04HSeq = paperSv04HSeq;
	}

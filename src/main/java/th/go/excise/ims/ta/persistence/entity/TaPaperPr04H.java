...
@Entity
@Table(name = "TA_PAPER_PR04_H")
public class TaPaperPr04H extends BaseEntity {

	private static final long serialVersionUID = 2232115501934118158L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR04_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR04_H_GEN", sequenceName = "TA_PAPER_PR04_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR04_H_SEQ")
	private Long paperPr04HSeq;
	...
	public Long getPaperPr04HSeq() {
		return paperPr04HSeq;
	}

	public void setPaperPr04HSeq(Long paperPr04HSeq) {
		this.paperPr04HSeq = paperPr04HSeq;
	}

...
@Entity
@Table(name = "TA_PAPER_PR02_H")
public class TaPaperPr02H extends BaseEntity {

	private static final long serialVersionUID = -7939539334397396911L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR02_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR02_H_GEN", sequenceName = "TA_PAPER_PR02_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR02_H_SEQ")
	private Long paperPr02HSeq;
	...
	public Long getPaperPr02HSeq() {
		return paperPr02HSeq;
	}

	public void setPaperPr02HSeq(Long paperPr02HSeq) {
		this.paperPr02HSeq = paperPr02HSeq;
	}

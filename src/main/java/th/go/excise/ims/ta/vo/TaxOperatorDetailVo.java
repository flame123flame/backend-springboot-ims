...
public class TaxOperatorDetailVo {
	...
	public String getCentralSelDate() {
		return centralSelDate;
	}

	public void setCentralSelDate(String centralSelDate) {
	...
	public String getSectorSelDate() {
		return sectorSelDate;
	}

	public void setSectorSelDate(String sectorSelDate) {
	...
	public String getAreaSelDate() {
		return areaSelDate;
	}

	public void setAreaSelDate(String areaSelDate) {

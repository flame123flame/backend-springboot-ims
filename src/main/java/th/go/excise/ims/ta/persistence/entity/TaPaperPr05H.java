...
@Entity
@Table(name = "TA_PAPER_PR05_H")
public class TaPaperPr05H extends BaseEntity {

	private static final long serialVersionUID = 7069044524423095563L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR05_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR05_H_GEN", sequenceName = "TA_PAPER_PR05_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR05_H_SEQ")
	private Long paperPr05HSeq;
	...
	public Long getPaperPr05HSeq() {
		return paperPr05HSeq;
	}

	public void setPaperPr05HSeq(Long paperPr05HSeq) {
		this.paperPr05HSeq = paperPr05HSeq;
	}

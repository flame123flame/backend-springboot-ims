...
@Entity
@Table(name = "TA_PAPER_PR06_H")
public class TaPaperPr06H extends BaseEntity {

	private static final long serialVersionUID = 4159437701226513175L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR06_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR06_H_GEN", sequenceName = "TA_PAPER_PR06_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR06_H_SEQ")
	private Long paperPr06HSeq;
	...
	public Long getPaperPr06HSeq() {
		return paperPr06HSeq;
	}

	public void setPaperPr06HSeq(Long paperPr06HSeq) {
		this.paperPr06HSeq = paperPr06HSeq;
	}

...
public class TaFormTS0119Vo extends AbstractTaFormTsVo {
	...
	public String getRefBookDateStr() {
		return refBookDateStr;
	}

	public void setRefBookDateStr(String refBookDateStr) {
		this.refBookDateStr = refBookDateStr;
	}

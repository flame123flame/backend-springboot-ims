...
@Entity
@Table(name = "TA_FORM_TS0423_HDR")
public class TaFormTs0423Hdr extends BaseEntity {

	private static final long serialVersionUID = 6431726876625600127L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_FORM_TS0423_HDR_GEN")
	@SequenceGenerator(name = "TA_FORM_TS0423_HDR_GEN", sequenceName = "TA_FORM_TS0423_HDR_SEQ", allocationSize = 1)
	@Column(name = "FORM_TS0423_HDR_ID")
	private Long formTs0423HdrId;
	...
	public Long getFormTs0423HdrId() {
		return formTs0423HdrId;
	}

	public void setFormTs0423HdrId(Long formTs0423HdrId) {
		this.formTs0423HdrId = formTs0423HdrId;
	}

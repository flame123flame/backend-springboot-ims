...
@Entity
@Table(name = "TA_PAPER_PR11_H")
public class TaPaperPr11H extends BaseEntity {

	private static final long serialVersionUID = 8755497211066219765L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR11_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR11_H_GEN", sequenceName = "TA_PAPER_PR11_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR11_H_SEQ")
	private Long paperPr11HSeq;
	...
	public Long getPaperPr11HSeq() {
		return paperPr11HSeq;
	}

	public void setPaperPr11HSeq(Long paperPr11HSeq) {
		this.paperPr11HSeq = paperPr11HSeq;
	}

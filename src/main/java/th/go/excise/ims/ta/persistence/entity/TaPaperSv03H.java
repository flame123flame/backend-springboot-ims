...
@Entity
@Table(name = "TA_PAPER_SV03_H")
public class TaPaperSv03H extends BaseEntity {

	private static final long serialVersionUID = 8708684655363271988L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_SV03_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_SV03_H_GEN", sequenceName = "TA_PAPER_SV03_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_SV03_H_SEQ")
	private Long paperSv03HSeq;
	...
	public Long getPaperSv03HSeq() {
		return paperSv03HSeq;
	}

	public void setPaperSv03HSeq(Long paperSv03HSeq) {
		this.paperSv03HSeq = paperSv03HSeq;
	}

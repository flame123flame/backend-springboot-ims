...
@Entity
@Table(name = "TA_PAPER_PR10_H")
public class TaPaperPr10H extends BaseEntity {

	private static final long serialVersionUID = -9089441960550123256L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR10_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR10_H_GEN", sequenceName = "TA_PAPER_PR10_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR10_H_SEQ")
	private Long paperPr10HSeq;
	...
	public Long getPaperPr10HSeq() {
		return paperPr10HSeq;
	}

	public void setPaperPr10HSeq(Long paperPr10HSeq) {
		this.paperPr10HSeq = paperPr10HSeq;
	}

...
@Entity
@Table(name = "TA_PAPER_PR03_H")
public class TaPaperPr03H extends BaseEntity {

	private static final long serialVersionUID = 7286428647929555311L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR03_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR03_H_GEN", sequenceName = "TA_PAPER_PR03_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR03_H_SEQ")
	private Long paperPr03HSeq;
	...
	public Long getPaperPr03HSeq() {
		return paperPr03HSeq;
	}

	public void setPaperPr03HSeq(Long paperPr03HSeq) {
		this.paperPr03HSeq = paperPr03HSeq;
	}

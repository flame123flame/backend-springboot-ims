...
@Entity
@Table(name = "TA_PAPER_SV05_H")
public class TaPaperSv05H extends BaseEntity {

	private static final long serialVersionUID = -3820340241688276113L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_SV05_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_SV05_H_GEN", sequenceName = "TA_PAPER_SV05_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_SV05_H_SEQ")
	private Long paperSv05HSeq;
	...
	public Long getPaperSv05HSeq() {
		return paperSv05HSeq;
	}

	public void setPaperSv05HSeq(Long paperSv05HSeq) {
		this.paperSv05HSeq = paperSv05HSeq;
	}

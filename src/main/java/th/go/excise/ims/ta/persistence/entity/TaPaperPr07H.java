...
@Entity
@Table(name = "TA_PAPER_PR07_H")
public class TaPaperPr07H extends BaseEntity {

	private static final long serialVersionUID = -4315861251955905806L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR07_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR07_H_GEN", sequenceName = "TA_PAPER_PR07_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR07_H_SEQ")
	private Long paperPr07HSeq;
	...
	public Long getPaperPr07HSeq() {
		return paperPr07HSeq;
	}

	public void setPaperPr07HSeq(Long paperPr07HSeq) {
		this.paperPr07HSeq = paperPr07HSeq;
	}

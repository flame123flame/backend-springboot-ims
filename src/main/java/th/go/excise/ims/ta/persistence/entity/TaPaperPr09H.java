...
@Entity
@Table(name = "TA_PAPER_PR09_H")
public class TaPaperPr09H extends BaseEntity {

	private static final long serialVersionUID = -3847032262450141369L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR09_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR09_H_GEN", sequenceName = "TA_PAPER_PR09_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR09_H_SEQ")
	private Long paperPr09HSeq;
	...
	public Long getPaperPr09HSeq() {
		return paperPr09HSeq;
	}

	public void setPaperPr09HSeq(Long paperPr09HSeq) {
		this.paperPr09HSeq = paperPr09HSeq;
	}

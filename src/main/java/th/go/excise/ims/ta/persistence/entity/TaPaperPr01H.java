...
@Entity
@Table(name = "TA_PAPER_PR01_H")
public class TaPaperPr01H extends BaseEntity {

	private static final long serialVersionUID = -3145029669007800811L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TA_PAPER_PR01_H_GEN")
	@SequenceGenerator(name = "TA_PAPER_PR01_H_GEN", sequenceName = "TA_PAPER_PR01_H_SEQ", allocationSize = 1)
	@Column(name = "PAPER_PR01_H_SEQ")
	private Long paperPr01HSeq;
	...
	public Long getPaperPr01HSeq() {
		return paperPr01HSeq;
	}

	public void setPaperPr01HSeq(Long paperPr01HSeq) {
		this.paperPr01HSeq = paperPr01HSeq;
	}

...
public interface TaPaperPr08HRepository extends CommonJpaCrudRepository<TaPaperPr08H, Long> {
	...
	public TaPaperPr08H findByPaperPrNumber(@Param("paperPrNumber") String paperPrNumber);
